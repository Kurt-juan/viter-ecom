...
const SearchBar = ({
  ...
  return (
    <form
      ...
      className="max-w-[250px] w-full relative"
    >
      <div className=" flex items-center">
        <input
          type="search"
          placeholder="Search here..."
          className="px-2 py-1 rounded-l-md border border-dark text-black w-full "
          ref={search}
          onChange={handleChange}
        />
        <button
          type="submit"
          className="px-2 py-1 rounded-r-md bg-dark border border-dark"
        >
          <Search />
        </button>
      </div>
